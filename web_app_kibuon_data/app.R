...
ui <- navbarPage(
  ...
  navbarMenu(
    ...
    tabPanel(
      "Age distribution", includeMarkdown("age_distribution.Rmd"),
    ...
    tabPanel(
      "Water Usage", includeMarkdown("water_usage.Rmd"),
      plotOutput("plot_3"),
      plotOutput("plot_4")
    )
  ),
